    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: RefreshIndicator(
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                ...
                                                                if( snapshot.data![index].mode == "video"){
                                                                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => videoCall(roomId: snapshot.data![index].link!, role: "host", appointmentData: snapshot.data![index], doctorProfile: widget.doctorProfile),));
                                                                }
          ...
          onRefresh: () {
            return Future(() => Navigator.of(context).push(MaterialPageRoute(builder: (context) => appointments(id: widget.id, index: widget.index, doctorProfile: widget.doctorProfile,),)));
          },
        )
      ),
    );
